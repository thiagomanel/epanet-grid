 ...
 * since 25/06/2007
 */
public class TankMinimunVolumeTest extends TestCase {

	/*
	 * Test method for 'org.epanetgrid.perturbador.perturbadores.tank.TankMinimunVolume.disturb(ITank)'
	 */
	public void testDisturbITank() {
		...
		ITank tankPert = new TankMinimunVolume(baseTank.label(), newValue).disturb(baseTank);
		...
		assertEquals(Measure.valueOf(newValue, Length.SI_UNIT).getEstimatedValue(), 
				tankPert.getMinimumVolume().getEstimatedValue());
	}
