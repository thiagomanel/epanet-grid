 ...
 * since 25/06/2007
 */
public class PipeLossCoefPerturbadorTest extends TestCase {

	/*
	 * Test method for 'org.epanetgrid.perturbador.perturbadores.pipes.PipeLossCoefPerturbador.disturb(IPipe)'
	 */
	public void testDisturbIPipe() {
		...
		IPipe pipePert = new PipeLossCoefPerturbador(basePipe.label(), newValue).disturb(basePipe);
