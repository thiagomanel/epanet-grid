 ...
 * since 25/06/2007
 */
public class TankMinimunWaterLevelTest extends TestCase {

	/*
	 * Test method for 'org.epanetgrid.perturbador.perturbadores.tank.TankMinimunWaterLevel.disturb(ITank)'
	 */
	public void testDisturbITank() {
		...
		ITank tankPert = new TankMinimunWaterLevel(baseTank.label(), newValue).disturb(baseTank);
		...
		assertEquals(Measure.valueOf(newValue, Length.SI_UNIT).getEstimatedValue(), 
				tankPert.getMinimumWaterLevel().getEstimatedValue());
	}
